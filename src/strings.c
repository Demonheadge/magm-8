...
const u8 gText_EnergyBall36SP[] = _("Energy Ball{CLEAR_TO 0x4E}36SP");
const u8 gText_PsychoCut36SP[] = _("Psycho Cut{CLEAR_TO 0x4E}36SP");
const u8 gText_DarkPulse36SP[] = _("Dark Pulse{CLEAR_TO 0x4E}36SP");
const u8 gText_UTurn24SP[] = _("U-Turn{CLEAR_TO 0x4E}24SP");
const u8 gText_Hex24SP[] = _("Hex{CLEAR_TO 0x4E}24SP");
const u8 gText_RazorShell24SP[] = _("Razor Shell{CLEAR_TO 0x4E}24SP");
const u8 gText_SwordsDance72SP[] = _("Swords Dance{CLEAR_TO 0x4E}72SP");
const u8 gText_Hurricane60SP[] = _("Hurricane{CLEAR_TO 0x4E}60SP");
const u8 gText_SteelWing24SP[] = _("Steel Wing{CLEAR_TO 0x4E}24SP");
const u8 gText_LeechLife12SP[] = _("Leech Life{CLEAR_TO 0x4E}12SP");
const u8 gText_Crunch24SP[] = _("Crunch{CLEAR_TO 0x4E}24SP");
const u8 gText_Tailwind24SP[] = _("Tailwind{CLEAR_TO 0x4E}24SP");
const u8 gText_LavaPlume36SP[] = _("Lava Plume{CLEAR_TO 0x4E}36SP");
