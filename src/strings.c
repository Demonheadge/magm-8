...
const u8 gText_AntifirePotion24SP[] = _("Antifire Potion{CLEAR_TO 0x5E}24SP");
const u8 gText_AntiDragonShield36SP[] = _("Anti-Dragon Shield{CLEAR_TO 0x5E}36SP");
const u8 gText_BlackMask48SP[] = _("Black Mask{CLEAR_TO 0x5E}48SP");
const u8 gText_BlessedSet72SP[] = _("Blessed Set{CLEAR_TO 0x5E}72SP");
const u8 gText_BroadArrows24SP[] = _("Broad Arrows{CLEAR_TO 0x5E}24SP");
const u8 gText_BroadBolts24SP[] = _("Broad Bolts{CLEAR_TO 0x5E}24SP");
const u8 gText_EternalBoots36SP[] = _("Eternal Boots{CLEAR_TO 0x5E}36SP");
const u8 gText_FireCape60SP[] = _("Fire Cape{CLEAR_TO 0x5E}60SP");
const u8 gText_GodCape60SP[] = _("God Cape{CLEAR_TO 0x5E}60SP");
const u8 gText_InfernalCape72SP[] = _("Infernal Cape{CLEAR_TO 0x5E}72SP");
const u8 gText_MirrorShield24SP[] = _("Mirror Shield{CLEAR_TO 0x5E}24SP");
const u8 gText_MythicalCape48SP[] = _("Mythical Cape{CLEAR_TO 0x5E}48SP");
const u8 gText_ObsidianSet84SP[] = _("Obsidian Set{CLEAR_TO 0x5E}84SP");
const u8 gText_SalveAmulet60SP[] = _("Salve Amulet{CLEAR_TO 0x5E}60SP");
const u8 gText_SlayerHelmet72SP[] = _("Slayer Helmet{CLEAR_TO 0x5E}72SP");
const u8 gText_AssaultVest60SP[] = _("Assault Vest{CLEAR_TO 0x5E}60SP");
const u8 gText_ChoiceBand84SP[] = _("Choice Band{CLEAR_TO 0x5E}84SP");
const u8 gText_ChoiceScarf84SP[] = _("Choice Scarf{CLEAR_TO 0x5E}84SP");
const u8 gText_ChoiceSpecs84SP[] = _("Choice Specs{CLEAR_TO 0x5E}84SP");
const u8 gText_Eviolite60SP[] = _("Eviolite{CLEAR_TO 0x5E}60SP");
const u8 gText_ExpertBelt48SP[] = _("Expert Belt{CLEAR_TO 0x5E}48SP");
const u8 gText_FocusSash48SP[] = _("Focus Sash{CLEAR_TO 0x5E}48SP");
const u8 gText_HeavyDutyBoots36SP[] = _("Heavy-Duty Boots{CLEAR_TO 0x5E}36SP");
const u8 gText_Leftovers84SP[] = _("Leftovers{CLEAR_TO 0x5E}84SP");
const u8 gText_LifeOrb72SP[] = _("Life Orb{CLEAR_TO 0x5E}72SP");
const u8 gText_LumBerry48SP[] = _("Lum Berry{CLEAR_TO 0x5E}48SP");
const u8 gText_RockyHelmet48SP[] = _("Rocky Helmet{CLEAR_TO 0x5E}48SP");
const u8 gText_SalacBerry36SP[] = _("Salac Berry{CLEAR_TO 0x5E}36SP");
const u8 gText_AirBalloon12SP[] = _("Air Balloon{CLEAR_TO 0x5E}12SP");
const u8 gText_DampRock12SP[] = _("Damp Rock{CLEAR_TO 0x5E}12SP");
const u8 gText_ElectricSeed12SP[] = _("Electric Seed{CLEAR_TO 0x5E}12SP");
const u8 gText_GrassySeed12SP[] = _("Grassy Seed{CLEAR_TO 0x5E}12SP");
const u8 gText_HeatRock12SP[] = _("Heat Rock{CLEAR_TO 0x5E}12SP");
const u8 gText_IcyRock12SP[] = _("Icy Rock{CLEAR_TO 0x5E}12SP");
const u8 gText_LiechiBerry24SP[] = _("Liechi Berry{CLEAR_TO 0x5E}24SP");
const u8 gText_LightClay24SP[] = _("Light Clay{CLEAR_TO 0x5E}24SP");
const u8 gText_MistySeed12SP[] = _("Misty Seed{CLEAR_TO 0x5E}12SP");
const u8 gText_PetayaBerry24SP[] = _("Petaya Berry{CLEAR_TO 0x5E}24SP");
const u8 gText_PsychicSeed12SP[] = _("Psychic Seed{CLEAR_TO 0x5E}12SP");
const u8 gText_SmoothRock12SP[] = _("Smooth Rock{CLEAR_TO 0x5E}12SP");
const u8 gText_TerrainExtender24SP[] = _("Terrain Extender{CLEAR_TO 0x5E}24SP");
const u8 gText_ThroatSpray12SP[] = _("Throat Spray{CLEAR_TO 0x5E}12SP");
const u8 gText_WhiteHerb24SP[] = _("White Herb{CLEAR_TO 0x5E}24SP");
