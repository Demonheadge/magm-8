...
const u8 gText_SideQuestName_5[] = _("Mutated Bloodvelds");
...
const u8 gText_SideQuestDesc_5[] = _("Slay {STR_VAR_3} Mutated Bloodveld(s).");
...
const u8 gText_SideQuestDoneDesc_5[] = _("Completed Mutated Bloodvelds");
